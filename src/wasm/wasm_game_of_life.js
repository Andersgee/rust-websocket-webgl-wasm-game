...
export class Universe {
    ...
    */
    onmessage_f32array(f32arr) {
        const ptr0 = passArrayF32ToWasm0(f32arr, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.universe_onmessage_f32array(this.ptr, ptr0, len0);
    }
    /**
    * @param {string} str
    */
    onmessage_string(str) {
        const ptr0 = passStringToWasm0(str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.universe_onmessage_string(this.ptr, ptr0, len0);
    }
    /**
    * @param {number} row
    * @param {number} column
    ...
    */
    cells_ptr() {
        const ret = wasm.universe_cells_ptr(this.ptr);
        return ret;
    }
    /**
    */
